 ...
 * Phase 0 (>66% HP): steady pressure with spread / rain.
 * Phase 1 (33–66%): adds circle bursts and laser column.
 * Phase 2 (<33%): adds spiral, hell-mode multi-pattern.
...
module.exports = {
  ...
  attackQueues: [
    ["normal", "spread", "rain", "normal", "spread"],
    ["spread",  "rain",  "circle", "laser", "normal"],
    ["spiral",  "hell",  "laser",  "circle", "rain"],
  ],
  ...
  // Column attack (vertical strike): used by "laser" attackType
  columnAttack: {
    type:     "laser",
    warnMs:   1600,
    activeMs: 700,
    ...
    damage:   22,
    color:    0xff3333,
    // "boss" = column at boss.x; "char" = column at char.x
    targetMode: "boss",
  },
  ...
  special: {
    ...
    windUpMs:    2000,
    durationMs:  9000,
    attackType:  "hell", // use hell after the burst
  },
};
